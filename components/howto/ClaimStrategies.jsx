  ...
  return (
    <div className="px-4 pb-16">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {CLAIM_STRATEGIES.map((strategy, index) => (
            <div
              key={index}
              className={`
                rounded-3xl p-8 border-2 relative overflow-hidden
            ...
            >
              {/* 배경 효과 */}
              <div className={`
                absolute top-0 right-0 w-20 h-20 rounded-full blur-xl opacity-20
        ...
        {/* 추가 팁 */}
        <div className="mt-12 bg-purple-900/20 border-2 border-purple-500/30 rounded-2xl p-8">
