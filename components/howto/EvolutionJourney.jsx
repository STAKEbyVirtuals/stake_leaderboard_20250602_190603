...
import { useAccount } from 'wagmi'; // 🆕 지갑 연결 정보 가져오기
import TweetSubmissionForm from '../TweetSubmissionForm'; // 🆕 구글폼 모달
...
const EvolutionJourney = () => {
  ...
  const [showTweetModal, setShowTweetModal] = useState(false); // 🆕 모달 상태
              ...
              {!walletAddress && (
                <div className="bg-yellow-500/20 border border-yellow-500/40 rounded-xl p-4 mb-4">
                  ...
                  <p className="text-sm text-gray-300">
                    Please connect your wallet to participate in the event and claim your 50,000 stSTAKE reward.
                  </p>
                </div>
              )}
